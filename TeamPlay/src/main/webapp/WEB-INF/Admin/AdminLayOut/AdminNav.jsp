    ...
    <div class="row">
        <div class="col-md-3">
            <ul class="nav nav-pills nav-stacked">
                ...
                <li><a href="http://www.jquery2dotnet.com"><i class="fa fa-tasks fa-fw"></i>포인트 관리</a></li>
                <li><a href="http://www.jquery2dotnet.com"><i class="fa fa-calendar fa-fw"></i>공지사항 관리</a></li>
                <li><a href="http://www.jquery2dotnet.com"><i class="fa fa-book fa-fw"></i>###</a></li>
