...
<div class="container" style="margin-top: 50px;">
	<table align="center" class="table table-hover">
		...
		<tbody>
			...
			<tr>
				<td colspan="2" style="min-height:300px;max-height: 300px; " align="center">
						            ...
						            <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
						                ...
						                <div class="carousel-inner">
						                 <c:if test="${vo.RE_img==1}">
						                    <div class="item active fit" >
						                        <img src="${fileName1}" class="fit" alt="First slide">
						                    ...
						                    <div class="item fit">
						                        <img src="${fileName2}" class="fit" alt="Second slide">
						                        <div class="carousel-caption">
						                            <h3>
						                                </h3>
						                            <p>
						                    ...
						                    <div class="item fit">
						                        <img src="${fileName3}" class="fit" alt="Third slide">
						                        <div class="carousel-caption">
						                            <h3>
						                                </h3>
						                            <p>
